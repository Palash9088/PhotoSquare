...
const BulkProcessor: React.FC<BulkProcessorProps> = ({
  ...
  const hasGlobalFiltersApplied = images.some(img => 
    img.filters.grayscale !== globalFilters.grayscale ||
    img.filters.sepia !== globalFilters.sepia ||
    img.filters.brightness !== globalFilters.brightness ||
    img.filters.contrast !== globalFilters.contrast
  );
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={!hasGlobalFiltersApplied}
