...
const FormatPresetSelector: React.FC<FormatPresetSelectorProps> = ({
  ...
  const groupedPresets = formatPresets.reduce((acc, preset) => {
    const key = preset.platform || 'General';
    if (!acc[key]) acc[key] = [];
    acc[key].push(preset);
    return acc;
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border">
      <div className="p-4 border-b">
        ...
        <p className="text-sm text-gray-500 mt-1">Choose the perfect format for your platform</p>
      </div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-shrink-0">
                      <div className={`
                        w-12 h-12 border-2 rounded-lg flex items-center justify-center text-lg
                        ${selectedPreset.id === preset.id
